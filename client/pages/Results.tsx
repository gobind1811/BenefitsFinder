...
const schemes = [
  ...
  },
  {
    ...
    eligibility: ["BPL (Below Poverty Line) households", "Priority households under NFSA"],
    applyUrl: "https://dfpd.gov.in/",
    process: "Eligible beneficiaries receive food grains automatically through their ration cards. Learn more on the official portal.",
  },
  {
    id: "pmjdy",
  ...
  return (
    <section className="container py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        {schemes.map((s) => (
          <div key={s.id} className="bg-white rounded-md shadow p-6 flex flex-col justify-between">
            ...
            <div>
              <a href={s.applyUrl} target="_blank" rel="noreferrer" className="inline-block w-full text-center px-4 py-2 bg-primary text-white rounded shadow-sm hover:opacity-95">
                Apply Now
              </a>
            </div>
          </div>
